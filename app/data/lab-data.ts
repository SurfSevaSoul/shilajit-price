...
export const LAB_DATA: Record<string, LabEntry> = {
  ...
  // COA by Certified Laboratories, Burbank CA (A2LA ISO 17025, Cert 3034.01)
  ...
  "lotus-blooming-authentic-shilajit": {
    ...
    coaStatus: "verified",
    coaUrl: "https://lotusbloomingherbs.com/?aff=380",
    testingLab: "Certified Laboratories, Burbank CA",
    testingLabAccreditation: "A2LA ISO 17025, Cert 3034.01",
    batchNumber: "BHC4429/2024057703",
    testDate: "August 2025",
    microbiologyClean: true,
    heavyMetals: { lead: "pass", mercury: "pass", arsenic: "pass", cadmium: "pass" },
    notes: [
