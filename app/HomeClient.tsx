...
function EditorPickCard({
  ...
  return (
    ...
    >
      ...
      {product.imageUrl && (
        <div className="relative w-full aspect-square mb-3 rounded-xl bg-[#E8F5EC] overflow-hidden">
...
export default function HomeClient({ blogPostCount }: { blogPostCount: number }) {
