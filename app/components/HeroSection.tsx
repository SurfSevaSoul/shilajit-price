  ...
  return (
    <section className="relative overflow-hidden bg-[#E8F5EC]">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 75% 30%, rgba(16,185,129,0.08) 0%, transparent 55%),
            radial-gradient(circle at 10% 80%, rgba(158,201,173,0.12) 0%, transparent 45%)`,
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1
              className="text-5xl sm:text-6xl lg:text-[64px] font-extrabold text-[#0D1F14] leading-[1.08] tracking-tight mb-5"
            ...
            <p className="text-lg text-[#4A6358] leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              ...
              <a
                href="#top-picks"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full border-2 border-[#182B1F] text-[#182B1F] hover:bg-[#182B1F] hover:text-white font-semibold transition-all duration-200 text-sm"
              >
                View Editor&apos;s Picks ↓
              </a>
            </div>
