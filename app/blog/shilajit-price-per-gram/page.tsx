...
const PRODUCTS = [
  ...
  { name: "Natural Shilajit RS Resin", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 1.08, fulvic: "Not Disclosed", coa: true, tp: true, source: "Himalaya", affiliate: "https://www.amazon.com/dp/B07KXVHNMV?tag=shilajitprice-20" },
  { name: "Essencraft Himalayan Resin", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 1.43, fulvic: "75%+", coa: true, tp: true, source: "Himalaya", affiliate: "https://www.amazon.com/dp/B0897H2SFN?tag=shilajitprice-20" },
  { name: "Sayan Shilajit 30g", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 0.90, fulvic: "~60%", coa: true, tp: false, source: "Siberian Altai", affiliate: "https://www.amazon.com/dp/B01MS9E5A9?tag=shilajitprice-20" },
  { name: "Sayan Shilajit 100g Bulk", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 0.72, fulvic: "~60%", coa: true, tp: false, source: "Siberian Altai", affiliate: "https://www.amazon.com/dp/B01MS9E5A9?tag=shilajitprice-20" },
  { name: "Pürblack Live Resin", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 2.97, fulvic: "Not Reported — DBP verified", coa: true, tp: true, source: "Multiple", affiliate: "https://www.amazon.com/dp/B01MU5VHNV?tag=shilajitprice-20" },
  { name: "Mountaindrop Shilajit", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 2.50, fulvic: "~70%", coa: true, tp: true, source: "Altai / Himalaya", affiliate: "https://www.amazon.com/dp/B08W4LFTP1?tag=shilajitprice-20" },
  { name: "Jarrow PrimaVie Caps", tier: "B", tierColor: "bg-blue-500 text-white", priceGram: "N/A", fulvic: "Std.", coa: true, tp: true, source: "India (licensed)", affiliate: "https://www.amazon.com/dp/B01NAMIYZ5?tag=shilajitprice-20" },
  { name: "Sun Potion Shilajit", tier: "B", tierColor: "bg-blue-500 text-white", priceGram: 3.33, fulvic: "~50%", coa: true, tp: false, source: "Himalaya", affiliate: "https://www.amazon.com/dp/B00WB8MVAQ?tag=shilajitprice-20" },
  { name: "Doctors Best Shilajit Caps", tier: "B", tierColor: "bg-blue-500 text-white", priceGram: "N/A", fulvic: "Std.", coa: true, tp: true, source: "India", affiliate: "https://www.amazon.com/dp/B002VE4S3A?tag=shilajitprice-20" },
  { name: "Primal Herb Shilajit Blend", tier: "B", tierColor: "bg-blue-500 text-white", priceGram: "N/A", fulvic: "~30%", coa: true, tp: false, source: "Undisclosed", affiliate: "https://www.amazon.com/dp/B07PV7XMVV?tag=shilajitprice-20" },
      ...
      >
        ...
        <section>
          ...
          <div className="space-y-4 text-sm text-[#0D1F14] leading-relaxed">
            ...
            <p>
              The question to ask: does the higher price correspond to higher verified fulvic acid content or better COA quality? In most cases, the answer is no. Pürblack charges ~$3.00/gram and does not report fulvic acid percentage — their quality markers are DBP (dibenzo-α-pyrones) content and Urolithin A ppm, verified by Pürblack Inc., Temecula, CA. Black Lotus publishes verified fulvic acid (64.51% resin / 74.30% capsules, Batch 93 COA) at $1.23/gram. The Pürblack premium reflects US patents, pharmaceutical-grade US manufacturing, and specialty formulations — not a higher disclosed FA%.
            </p>
            <p>
