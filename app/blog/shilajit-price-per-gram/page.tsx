...
const PRODUCTS = [
  ...
  { name: "Pürblack Live Resin", tier: "A", tierColor: "bg-emerald-500 text-white", priceGram: 2.97, fulvic: "Not Reported — DBP verified", coa: true, tp: true, source: "Multiple", affiliate: "https://www.amazon.com/dp/B01MU5VHNV?tag=shilajit0a-20" },
