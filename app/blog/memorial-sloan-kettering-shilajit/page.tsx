    ...
    >
      ...
      <section>
        ...
        <p className="text-sm text-[#4A6358] leading-relaxed">
          ...
          For a deeper look at the evidence — including{" "}
          <Link href="/blog/nccih-shilajit-safety" className="text-[#10B981] hover:underline font-semibold">NCCIH has issued similar guidance on shilajit safety</Link>
          {" "}and why heavy metals matter specifically during pregnancy, and what alternatives exist — see{" "}
      ...
      <section>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          ].map(({ brand, tier, tierColor, tagline, bullets, href, btnColor, productName, discountNote }) => (
